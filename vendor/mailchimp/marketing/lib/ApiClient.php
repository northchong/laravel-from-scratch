    ...
    public function __construct(Configuration $config = null)
{
    ...
    $this->accountExport = new AccountExportApi($config);
    $this->accountExports = new AccountExportsApi($config);
    $this->activityFeed = new ActivityFeedApi($config);
    $this->authorizedApps = new AuthorizedAppsApi($config);
    $this->automations = new AutomationsApi($config);
    $this->batchWebhooks = new BatchWebhooksApi($config);
    $this->batches = new BatchesApi($config);
    $this->campaignFolders = new CampaignFoldersApi($config);
    $this->campaigns = new CampaignsApi($config);
    $this->connectedSites = new ConnectedSitesApi($config);
    $this->conversations = new ConversationsApi($config);
    $this->customerJourneys = new CustomerJourneysApi($config);
    $this->ecommerce = new EcommerceApi($config);
    $this->facebookAds = new FacebookAdsApi($config);
    $this->fileManager = new FileManagerApi($config);
    $this->landingPages = new LandingPagesApi($config);
    $this->lists = new ListsApi($config);
    $this->ping = new PingApi($config);
    $this->reporting = new ReportingApi($config);
    $this->reports = new ReportsApi($config);
    $this->root = new RootApi($config);
    $this->searchCampaigns = new SearchCampaignsApi($config);
    $this->searchMembers = new SearchMembersApi($config);
    $this->surveys = new SurveysApi($config);
    $this->templateFolders = new TemplateFoldersApi($config);
    $this->templates = new TemplatesApi($config);
    $this->verifiedDomains = new VerifiedDomainsApi($config);
}
